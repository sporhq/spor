...
// Mirrors scripts/engines/util.js's inferenceRoot(), duplicated rather than
// imported: that module already requires this one (loadConfig), so the reverse
// import would cycle. Fail-open: any git failure (no git, not a repo, cwd
// unset) returns null, so a plain checkout's ancestor walk is unaffected.
