...
const TERMINAL_SIGNATURES = Object.freeze([
  { signal: "credit-exhausted", class: "environment", re: /out of usage credits|credit balance is too low|insufficient credits|purchase more credits/i },
  ...
  // possessive forms are anchored on `your`, so a log line that merely mentions
  // a usage limit in prose does not read as this run hitting one.
