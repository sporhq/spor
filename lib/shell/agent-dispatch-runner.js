...
function carryGateFields(file, next) {
  try {
    ...
    for (const [k, v] of Object.entries(onDisk)) {
      if (k.startsWith("gate_") || k.startsWith(candidateKernel.IMPL_FIELD_PREFIX)) gate[k] = v;
    }
...
module.exports = {
  ...
  terminalOutcomeBackfill, mergeTerminalOutcome, stampGateState, stampImplState,
