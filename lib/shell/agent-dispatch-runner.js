...
function beginNativeRun(home, { harness, name, nodeId, cwd, model, runId, readOnly = false, now = () => new Date().toISOString() }) {
...
function reconcileRuns(home, { agents = [], enumerated = true, env = process.env, now = () => new Date().toISOString(), graceMs = 60000, staleMs = 86400000, readTicks = processStartTicks } = {}) {
...
module.exports = {
  ...
  isRunLive, finalizeRun, finalizeSupervisedRun, observedActivityAt, stopRun, finalizeIdleRun, stopIdleRun, settleContractOutcome, stampRun,
