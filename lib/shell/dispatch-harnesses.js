...
// declarations (`readOnly` / `unattended`; attended is the absence of both).
...
const ADAPTERS = Object.freeze({
  ...
  "claude-code": Object.freeze({
    ...
    readOnly: Object.freeze({ permissionMode: "plan" }),
    // …and the UNATTENDED one: Claude Code is the only harness that needs a
    // flag to run with nobody there to answer a prompt (see CLAUDE_UNATTENDED).
    unattended: CLAUDE_UNATTENDED,
  ...
  opencode: Object.freeze({
    ...
    // Unattended needs no flag: `--auto` is already in opencodeArgs.
    unattended: Object.freeze({}),
