...
function buildAttestationNode({ item, factory, gate, integration = null, environment = {}, now = Date.now, date = null, signing = null }) {
  ...
  if (markdown == null) {
    ...
    minimal.configIntegrity = { ...minimal.configIntegrity, gates: [], gates_elided: attestation.configIntegrity.gates.length, protected_paths: [], protected_paths_elided: protectedList(attestation.configIntegrity).length };
