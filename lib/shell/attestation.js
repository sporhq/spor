...
function verifyAttestation(att, { key = null, keyId = null, now = Date.now, maxAgeMs = null, commit = null, target = null, targetRef = null, factoryDigest = null, trusted = null, requireSignature = false, requireTrusted = false } = {}) {
  const checks = [];
