...
const { networkGit: sharedNetworkGit } = require("./git-network.js");
const PROBE_TIMEOUT_MS = 5000;
const networkGit = (git, cwd, args) => sharedNetworkGit(git, cwd, args, { timeout: PROBE_TIMEOUT_MS, maxBuffer: 256 * 1024 });
