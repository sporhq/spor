...
async function runWorkLoop({ opts = {}, deps, control = {} }) {
  ...
  const status = {
    ...
    ...(deps.gate ? { gates: { passed: 0, failed: 0, blocked: 0, parked: 0, superseded: 0 }, factory: opts.factory || null, ...(repos.length ? { repos } : {}) } : {}),
    active: [],
    gating: [],
    recent: [],
    skipped: [],
  ...
  const settleGates = () => {
    ...
    for (const g of status.gating) {
      ...
      // like a pass: no cooldown, nothing to keep this worker away from.
