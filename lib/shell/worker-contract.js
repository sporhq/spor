...
// more. The one FIXED FORM in it — `DECLINED: <reason>` as the first line of
// the final message — is the worker's declared decline, read back by
// dispatch-terminal.js (parseDecline); change the two together.
"use strict";
