...
function workerContract({ nodeId, factory = null, terminal = null } = {}) {
  ...
  const lines = [
    ...
    `makes the item stale. Leave \`${id}\` where the scoping put it: re-stamped to the repo that owns it and`,
    "still open, or retired. Then make the FIRST line of your final message exactly",
