...
function buildGateFact({ gate, nodeId, runId, project, verdict, detail, evidence, attempts, escalatedTo, demotion, date, factory }) {
...
async function runGatePipeline({ item, factory, deps, log = () => {} }) {
  ...
  const record = async (gate, { verdict, detail, evidence, attempts, escalatedTo, demotion }) => {
    let factId = null;
    try {
