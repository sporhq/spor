...
const FAILURE_LINE_RE = /(^|\s)(not ok\b|✖|●|FAIL\b|failing tests|AssertionError|Error:|error TS\d+|Failed tasks|failed\b)/;
...
function prepareGateTree(change, { trustedRef, protectedPaths, setup = null }) {
  let parent = null;
  try {
