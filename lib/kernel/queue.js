...
// (task-cc-spor-tier-2-scale). Fills blockingCounts for every queueable-live,
// unresolved node — the superset any project/assignee/type-filtered rankQueue
// draws from, so every later read is a pure cache hit. Returns the index.
