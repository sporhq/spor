...
function compile(graph, opts = {}) {
  ...
  // 0-3 (irrelevant/background/directly-relevant/required), noul whether
  // this candidate answers or resolves the query. compile() stays pure: it
  ...
  if (DIGEST) {
    ...
    if (RERANK_SCORES) {
      ...
      scored.sort((a, b) => {
        ...
        const na = ra.noul ? 1 : 0;
        const nb = rb.noul ? 1 : 0;
